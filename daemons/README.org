...
* 13.1 Introduction
:PROPERTIES:
:CUSTOM_ID: section-13-1
:END:

* 13.2 Daemon Characteristics
:PROPERTIES:
:CUSTOM_ID: section-13-2
:END:

* 13.3 Coding Rules
:PROPERTIES:
:CUSTOM_ID: section-13-3
:END:

* 13.4 Error Logging
:PROPERTIES:
:CUSTOM_ID: section-13-4
:END:

* 13.5 Single-Instance Daemons
:PROPERTIES:
:CUSTOM_ID: section-13-5
:END:

* 13.6 Daemon Conventions
:PROPERTIES:
:CUSTOM_ID: section-13-6
:END:

* 13.7 Client–Server Model
:PROPERTIES:
:CUSTOM_ID: section-13-7
:END:

* 13.8 Summary
:PROPERTIES:
:CUSTOM_ID: section-13-8
:END:
