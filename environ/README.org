...
* 7.1 Introduction
:PROPERTIES:
:CUSTOM_ID: section-7-1
:END:

* 7.2 main Function
:PROPERTIES:
:CUSTOM_ID: section-7-2
:END:

* 7.3 Process Termination
:PROPERTIES:
:CUSTOM_ID: section-7-3
:END:

* 7.4 Command-Line Arguments
:PROPERTIES:
:CUSTOM_ID: section-7-4
:END:

* 7.5 Environment List
:PROPERTIES:
:CUSTOM_ID: section-7-5
:END:

* 7.6 Memory Layout of a C Program
:PROPERTIES:
:CUSTOM_ID: section-7-6
:END:

* 7.7 Shared Librar ies
:PROPERTIES:
:CUSTOM_ID: section-7-7
:END:

* 7.8 Memory Allocation
:PROPERTIES:
:CUSTOM_ID: section-7-8
:END:

* 7.9 Environment Variables
:PROPERTIES:
:CUSTOM_ID: section-7-9
:END:
...
:PROPERTIES:
:CUSTOM_ID: section-7-10
:END:

* 7.11 =getrlimit= and =setrlimit= Functions
:PROPERTIES:
:CUSTOM_ID: section-7-11
:END:

* 7.12 Summary
:PROPERTIES:
:CUSTOM_ID: section-7-12
:END:
