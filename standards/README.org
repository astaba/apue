...
** 2.3.5 Mac OS X
:PROPERTIES:
:CUSTOM_ID: section-2-3-5
:END:

** 2.3.6 Solaris
:PROPERTIES:
:CUSTOM_ID: section-2-3-6
:END:

** 2.3.7 Other UNIX Systems
:PROPERTIES:
:CUSTOM_ID: section-2-3-7
:END:
...
:PROPERTIES:
:CUSTOM_ID: section-2-5-4
:END:

** 2.5.5 Indeterminate Runtime Limits
:PROPERTIES:
:CUSTOM_ID: section-2-5-5
:END:

* 2.6 Options
:PROPERTIES:
:CUSTOM_ID: section-2-6
:END:

* 2.7 Feature Test Macros
:PROPERTIES:
:CUSTOM_ID: section-2-7
:END:

* 2.8 Primitive System Data Types
:PROPERTIES:
:CUSTOM_ID: section-2-8
:END:

* 2.9 Differences Between Standards
:PROPERTIES:
:CUSTOM_ID: section-2-9
:END:

* 2.10 Summary
:PROPERTIES:
:CUSTOM_ID: section-2-10
:END:
