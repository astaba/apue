...
* 2.1 Introduction
:PROPERTIES:
:CUSTOM_ID: 21-introduction
:END:

* 2.2 UNIX Standardization
:PROPERTIES:
:CUSTOM_ID: 22-unix-standardization
:END:
...
** 2.2.2 IEEE POSIX
:PROPERTIES:
:CUSTOM_ID: 222-ieee-posix
:END:

** 2.2.3 The Single UNIX Specification
:PROPERTIES:
:CUSTOM_ID: 223-the-single-unix-specification
:END:
...
:PROPERTIES:
:CUSTOM_ID: 23-unix-system-implementations
:END:

** 2.3.1 UNIX System V Release 4
:PROPERTIES:
:CUSTOM_ID: 231-unix-system-v-release-4
:END:
...
** 2.3.5 Mac OS X
:PROPERTIES:
:CUSTOM_ID: 235-mac-os-x
:END:

** 2.3.6 Solaris
:PROPERTIES:
:CUSTOM_ID: 236-solaris
:END:

** 2.3.7 Other UNIX Systems
:PROPERTIES:
:CUSTOM_ID: 237-other-unix-systems
:END:

* 2.4 Relationship of Standards and Implementations
:PROPERTIES:
:CUSTOM_ID: 24-relationship-of-standards-and-implementations
:END:
...
** 2.5.1 ISO C Limits
:PROPERTIES:
:CUSTOM_ID: 251-iso-c-limits
:END:

** 2.5.2 POSIX Limits
:PROPERTIES:
:CUSTOM_ID: 252-posix-limits
:END:
...
** 2.5.3 XSI Limits
:PROPERTIES:
:CUSTOM_ID: 253-xsi-limits
:END:

** 2.5.4 sysconf, pathconf, and fpathconf Functions
:PROPERTIES:
:CUSTOM_ID: 254-sysconf-pathconf-and-fpathconf-functions
:END:

** 2.5.5 Indeterminate Runtime Limits
:PROPERTIES:
:CUSTOM_ID: 255-indeterminate-runtime-limits
:END:

* 2.6 Options
:PROPERTIES:
:CUSTOM_ID: 26-options
:END:

* 2.7 Feature Test Macros
:PROPERTIES:
:CUSTOM_ID: 27-feature-test-macros
:END:

* 2.8 Primitive System Data Types
:PROPERTIES:
:CUSTOM_ID: 28-primitive-system-data-types
:END:

* 2.9 Differences Between Standards
:PROPERTIES:
:CUSTOM_ID: 29-differences-between-standards
:END:

* 2.10 Summary
:PROPERTIES:
:CUSTOM_ID: 210-summary
:END:
